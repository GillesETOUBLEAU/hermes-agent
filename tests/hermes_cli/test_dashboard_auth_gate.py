...
def test_start_server_gate_with_provider_proceeds_and_sets_proxy_headers(monkeypatch):
    ...
    try:
        ...
        # with no dashboard.trusted_proxies configured must trust the
        # forwarding peer or X-Forwarded-Proto is ignored and cookies lose
        # their Secure flag.  Configuring trusted_proxies narrows this back
        # down — see test_start_server_passes_bounded_trusted_proxy_networks.
