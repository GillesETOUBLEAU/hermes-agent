...
def _parse_tool_call(agent, tool_call, *, flatten_probe: bool = False) -> _ParsedCall:
    ...
    if parse_error is None:
        ...
        # After the unwrap, so the snap sees the real tool's schema rather than the
        # tool_call bridge's. Single funnel for both executors.
        _snap_enum_arguments(agent, name, args)
