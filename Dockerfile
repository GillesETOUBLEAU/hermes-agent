...
# google-api-python-client, google-auth-oauthlib, google-auth-httplib2 are
# pulled in by the [google] extra (transitively via [all]) — no extra pip
# step needed for the google-workspace skill.
